...
---@class RemotifyConfigItem
---@field ssh_conn SSHConn
---@field remote_dir string
---@field updated_at_unix integer

---@param local_dir string
---@return RemotifyConfigItem|nil
function M.get(local_dir)
  local db = load()
  return db.items[local_dir]
end

--- Save config for the local_dir.
---@param local_dir string
---@param ssh_conn SSHConn
